...
(function($) {
    ...
    YM.page.header.initHeadBar = function() {
        ...
        if (this.container.find('.head-logo .logo-channel').size() > 0) {
            headbarElm.find('.myaccount').addClass('bldr').before('<li class="bold"><a href="//www.yesmywine.com/" target="_blank">也买酒首页</a></li>');
        }
    ...
    YM.page.header.showUserInfo = function(d, d2) {
        ...
        // 显示用户信息
        var tmpl = ['<li style="height:16px;overflow:hidden;">您好，<a href="{accountLink}' + d.memberId + '" title="{nickName}">' + userName + '<img align="absmiddle" width="16" height="16" src="//img11.yesmyimg.com/newWeb/images/global/member/s/{memberTinyIcon}.png" /></a></li>', '<li class="bldr message"><a href="javascript:;">新消息<em></em></a></li>', '<li class="bldr"><a href="{logoutLink}" class="txt-logout" onclick="YM.cookie.del(\'login_username\');YM.cookie.del(\'mc_uuid\');return true;">退出</a></li>'].join('');
    ...
    YM.page.header.showCellarTakeAlarm = function(count) {
        ...
        YM.page.msgtip('#header ul.sitelinks li.myaccount', '<a href="//www.yesmywine.com/personalCenter/showMyCellar.jspa?viewFlag=1" target="_blank">您的存酒库内有<strong style="color:#f00;margin:0 5px;">' + count + '</strong>瓶酒即将到期！</a>', {
            position: 'yellow',
            width: 250
        });
        YM.load('util-msgtip',
    ...
    YM.page.header.cart.addGood = function(goodsId, amountId, goodsYearId) {
        // 此方法会在//www.yesmywine.com/cart3/js/cart_api.js中重新定义
    };
    ...
    YM.page.header.cart.show = function(d) {
        ...
        if (d.totalGoodsAmount) {
            ...
            headcartElm.find('.shopcart-list').html('<div class="empty">您的购物车内暂时没有商品，去<a href="//www.yesmywine.com/">首页</a>挑选</div>');
        }
    };
    ...
    YM.page.header.initSign = function(){
        $('.sign_up').click(function() {
            YM.login.pop(function() {
                YM.dataproxy.getJSON('//www.yesmywine.com/marketing/getIntegralByOrderAmount.jspa', function(d) {
   ...
   // 头部通栏处理
    YM.page.header.initTopline = function() {
        $('.e-topline').each(function() {
            ...
            var $this = $(this);
            //var flag = 1;
            //var Imgurl1="url(//img14.yesmyimg.com/images/event/2015/10/019855/tl01.jpg) 50% 0 no-repeat";
            //var Imgurl2="url(//img14.yesmyimg.com/images/event/2015/10/019855/tl02.jpg) 50% 0 no-repeat";
...
//                          }
    ...
    YM.page.header.menuBar =  function() {
        ...
        $("#submitAdvice").click(
                function() {
                    ...
                    YM.dataproxy.getJSON("//www.yesmywine.com/advice/sendAdvice.jspa",param,
                            function(data) {
                                if (data.flag == 1) {
    ...
    YM.page.header.loadCartMsg = function(d) {
        ...
        if (d.totalGoodsCount > 0) {
            ...
            for (var i = 0; i < 4 && i < d.goodsList.length; i++) {
                ...
                cartHtml += '<a class="prod-info" target="_blank" href="//www.yesmywine.com/goods/'
                        + goods.goodsId + '.html">';
            ...
            cartHtml += '<a class="btn btn-default" data-dts="S4" href="//www.yesmywine.com/cart4/showCart.jspa" target="_blank" data-dts="C2">查看购物车</a>';
    ...
    YM.page.header.userNologinLoad = function() {
        ...
        function() {
            var _h = $(window).height()*0.3 ;
            var url = window.location.hostname == "www.yesmywine.com" ? "/portal/toLogin.jspa?pagetype=pop&dataDts=S1" : "//www.yesmywine.com/portal/toLogin.jspa?pagetype=pop&crossdomain=true&dataDts=S1";
    ...
    YM.page.header.initPopContent = function() {
        ...
        $("#cnnCode").blur(function(){
            ...
            if(!cnnCode){
                $(this).css('background','url(//img10.yesmyimg.com/20140808/newWeb/css/v4/images/hp_v4/cnnCode.gif) no-repeat 10px center;');
            }else{
                $(this).css('background','none');
            }
        ...
        $("#validateCode").blur(function(){
            ...
            if(!validateCode){
                $(this).css('background','url(//img10.yesmyimg.com/20140808/newWeb/css/v4/images/hp_v4/validateCode.gif) no-repeat 10px center;');
        ...
        $(".form-group-code img,.feedback-table-vaild img").attr('scr','//img11.yesmyimg.com/newWeb/images/global/1px.gif');
        ...
        $("#validateCnn").click(
            function(){
                ...
                YM.dataproxy.getJSON("//www.yesmywine.com/goods/validateCnnCode.jspa",
                    param,
                    function(json) {
    ...
    YM.page.header.userLoginLoad = function(userData) {
        ...
        // 设置头像
        var imgHead = userData.imgUrl || '//imgblog.yesmyimg.com/microblog/images/headerDefault.jpg';
        var imgLink = '//space.yesmywine.com/' + userData.memberId;
        ...
        if(msg.sys != 0){
            $('.ym-nBar-pop-box').append('<li>您有<a class="txt-blue" target="_blank" href="//www.yesmywine.com/memberMessage/index.jspa">' + msg.sys + '</a>条未读消息</li>');
        };
        if(msg.overDueCoupon != 0){
            $('.ym-nBar-pop-box').append('<li>您有<a class="txt-blue" target="_blank" href="//www.yesmywine.com/personalCenter/getMyCoupon.jspa">' + msg.overDueCoupon + '</a> 张 优惠券 即将过期</li>');
        };
        if(msg.overDueCard != 0){
            $('.ym-nBar-pop-box').append('<li>您有<a class="txt-blue" target="_blank" href="//www.yesmywine.com/personalCenter/bindCard.jspa">' + msg.overDueCard + '</a> 张 礼品卡 即将过期</li>'); 
        };
    ...
    /*  YM.page.header.cut =function(){
            ...
            if(dd>='111316'){ $('.head-topline').css('background','url(//img13.yesmyimg.com/images/event/2015/11/cuthour.jpg) center top')}
            var hour=111324-dd
            $('.hour').append(hour)
      };  */      
})(jQuery);